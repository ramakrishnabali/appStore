...
class AppStore extends Component {
  ...
  updateCategory = () => {
    ...
    const categoryList = appsList.filter(
      eachItem => eachItem.category.toLowerCase() === category.toLowerCase(),
    )
    return categoryList
  }
  ...
  render() {
    ...
    const updatedList = this.updateCategory()
    const filteredResult = updatedList.filter(each =>
